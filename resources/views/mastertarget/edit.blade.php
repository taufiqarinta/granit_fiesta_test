        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('mastertarget.update', $masterTarget) }}" method="POST">
                        @csrf
                        @method('PUT')
                        
                        <div class="mb-4">
                            <label for="target" class="block text-gray-700 text-sm font-bold mb-2">Paket:</label>
                            <input type="text" name="target" id="target" value="{{ old('target', $masterTarget->target) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="point" id="point" value="{{ old('point', $masterTarget->point) }}" min="0"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="kupon" id="kupon" value="{{ old('kupon', $masterTarget->kupon) }}" min="0"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="periode_awal" id="periode_awal" value="{{ old('periode_awal', $masterTarget->periode_awal->format('Y-m-d')) }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="periode_akhir" id="periode_akhir" value="{{ old('periode_akhir', $masterTarget->periode_akhir->format('Y-m-d')) }}"
