...
<body>
    ...
    <div class="container">
        ...
        <div class="text-center mb-8">
            ...
            <div class="max-w-md mx-auto mb-6">
                <select 
                    id="doorprize_id" 
                    class="w-full px-4 py-3 bg-white text-black bg-opacity-20 border border-white border-opacity-30 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors"
                >
        ...
        <div id="voucherArea" class="hidden">
            ...
            <div class="text-center mt-8">
                <button onclick="startUndian()" class="bg-green-500 hover:bg-green-600">
    ...
    <div id="loading" class="hidden fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
        <div class="bg-white bg-opacity-20 rounded-lg p-8 text-center backdrop-blur-sm">
