<x-app-layout>
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex gap-3 items-center">
                            <input type="text" id="searchInput" placeholder="Cari nama toko/agen, PIC, alamat, kota, provinsi..." 
                            ...
                            <tbody>
                                @foreach($gabunganData as $index => $item)
                                    <tr id="row-{{ $item['id'] }}" 
                                        ...
                                        <td style="border: 1px solid #e5e7eb; padding: 12px; text-align: left; font-size: 0.875rem; color: #111827;">
                                            <div style="max-width: 120px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $wilayahData[$item['id']]['provinsi'] }}">
                                                {{ $wilayahData[$item['id']]['provinsi'] }}
                                            </div>
                                        </td>
                                        <td style="border: 1px solid #e5e7eb; padding: 12px; text-align: left; font-size: 0.875rem; color: #111827;">
    ...
    <script>
        ...
        //     const duplicateIds = row ? JSON.parse(row.getAttribute('data-duplicate-ids')) : [id];
