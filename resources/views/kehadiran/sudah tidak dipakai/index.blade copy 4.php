                    ...
                    <div class="table-container" style="width: 100%; overflow-x: auto; border: 1px solid #e5e7eb; border-radius: 8px;">
                        <table id="tabelDaftarToko" style="min-width: 1300px; width: 100%; border-collapse: collapse; background: white;">
                            <thead style="background-color: #f9fafb;">
                                <tr>
                                    <th style="border: 1px solid #e5e7eb; padding: 12px; text-align: center; font-size: 0.75rem; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em; left: 0; background: #f9fafb; z-index: 10; min-width: 60px;">No</th>
                            ...
                            <tbody>
                                @foreach($gabunganData as $index => $data)
                                    <tr id="row-{{ $data['id'] }}" style="{{ $data['hadir'] ? 'background-color: #f0fdf4;' : '' }} transition: background-color 0.15s ease-in-out;">
                                        <!-- Nomor Urut - Sticky -->
                                        <td style="border: 1px solid #e5e7eb; padding: 12px; text-align: center; font-size: 0.875rem; color: #111827; font-weight: 500;left: 0; background: inherit; z-index: 5;">
                                            {{ $index + 1 }}
                                        </td>
