...
<script>
    ...
    let scanLockTimeout = null, searchTimeout = null;
    ...
    async function startScanner() {
        ...
        try {
            ...
            const scanConfig = { fps: 10, qrbox: function(w, h) { const s = Math.floor(Math.min(w, h) * 0.75); return { width: s, height: s }; } };
    ...
    function onScanSuccess(decodedText) {
        ...
        searchData();
        scanLockTimeout = setTimeout(() => { scanLock = false; }, 1500);
    }
