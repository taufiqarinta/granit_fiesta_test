...
class FormOrderExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    ...
    public function headings(): array
    {
        return [
            ...
            'Lokasi Event',
            'Total Point',
            'Jumlah Voucher', // KOLOM BARU
            'Kode Unik Voucher', // KOLOM BARU
            'Kode Agen',
            'Nama Agen',
            'Nama Sales',
            'Hadir',
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->lokasi_event,
            $row->total_point,
            $row->total_voucher ?? 0, // KOLOM BARU: Jumlah Voucher
            $kodeUnikVoucher, // KOLOM BARU: Kode Unik Voucher
            $kodeAgenList,
            $namaAgenList,
            $namaSalesList,
            $statusHadir,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        for ($row = 2; $row <= $lastRow; $row++) {
            $sheet->getStyle("I{$row}:M{$row}")->getAlignment()->setWrapText(true); // UPDATE RANGE MENJADI I-M
        }
        ...
        return [
            ...
            'A:O' => [ // UPDATE RANGE MENJADI A-O
                'alignment' => [
                    'vertical' => \PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_TOP,
                ],
            ],
            'I:M' => [ // UPDATE RANGE MENJADI I-M
                'alignment' => [
                    'vertical' => \PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_TOP,
                    'wrapText' => true,
                ],
            ],
            // 'J' => [ // STYLE KHUSUS UNTUK KOLOM KODE UNIK VOUCHER
            //     'alignment' => [
            //         'vertical' => \PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_TOP,
            //         'wrapText' => true,
            //     ],
    ...
    public function columnWidths(): array
    {
        return [
            ...
            'G' => 20,   // Lokasi Event
            'H' => 12,   // Total Point
            'I' => 12,   // Jumlah Voucher (BARU)
            'J' => 20,   // Kode Unik Voucher (BARU)
            'K' => 15,   // Kode Agen
            'L' => 20,   // Nama Agen
            'M' => 20,   // Nama Sales
            'N' => 12,   // Hadir
            'O' => 15,   // Jumlah Kehadiran
        ];
    }
}