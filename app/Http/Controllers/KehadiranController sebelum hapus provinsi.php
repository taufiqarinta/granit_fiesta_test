...
class KehadiranController extends Controller
{
    ...
    //             $groupedData[$uniqueKey]['duplicate_ids'][] = 'toko_' . $item->id;
    ...
    //             // Buat grup baru
    //             $itemData = [
    //                 'id' => 'toko_' . $item->id, // Gunakan ID pertama sebagai ID utama
    //                 'type' => 'toko',
    ...
    //                 'nama_sales' => '-'
    //             ]],
    //             'duplicate_ids' => ['agen_' . $item->id]
    //         ];
            
    //         if (isset($groupedData[$uniqueKey])) {
    //             $groupedData[$uniqueKey]['duplicate_ids'][] = 'agen_' . $item->id;
    //         } else {
    //             $groupedData[$uniqueKey] = $itemData;
    //         }
    //     }
    ...
    //         'duplicate_ids' => 'sometimes|array'
    //     ]);

    //     try {
    //         $idsToUpdate = $request->duplicate_ids ?? [$request->id];
            
    //         foreach ($idsToUpdate as $id) {
    //             // Pisahkan type dan original_id
